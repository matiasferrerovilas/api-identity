...
class WorkspaceMembershipServiceTest extends Specification {
    ...
    WorkspaceMembershipService service = new WorkspaceMembershipService(workspaceMemberRepository, workspaceRepository)
    ...
    def "addMembership - saves a new COLLABORATOR membership"() {
        given:
